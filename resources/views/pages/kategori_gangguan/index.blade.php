...
<style>
  #kategoriGangguanListTable_paginate, #kategoriGangguanListTable_filter{
  ...
  <div class="content-wrapper">
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Kategori Gangguan</h4>
            <p class="card-description">
              @if(Auth::user()->role_id == 1)
                <a href="{{ route('kategori_gangguan_add') }}" class="btn btn-primary btn-rounded btn-sm">Tambah Kategori</a>
              @endif 
            </p>
            <div class="row">
            <div class="filter">
              ...
              <div class="table-responsive">
                <table class="table" id="kategoriGangguanListTable">
                  <thead>
                    <tr>
                      <th>Nama Kategori</th>
                      <th>Status</th>
...
function initFilter()
    ...
    function load_data() {
      var table = $('#kategoriGangguanListTable').DataTable({
        processing: true,
        serverSide: true,
        searching: false,
        lengthChange: false,
        ajax: {
          url:"/api/kategori-gangguan",
          type: "POST",
          data: {
  ...
  $('document').ready( function () {
    ...
    load_data();
      ...
      $('#filter').click(function(){
        $('#kategoriGangguanListTable').DataTable().destroy();
        load_data();
       });
